      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-6 items-start text-white">
          <div className="col-span-4">
            ...
            <p className="text-xl flex items-center space-x-4 font-bold">About <span><MdOutlineKeyboardArrowRight color="var(--text-white)" /></span> <span className="text-[var(--text-white)]">Our Team</span></p>
          </div>
        </div>
      </section>
  )

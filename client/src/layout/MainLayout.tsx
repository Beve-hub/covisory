...
const MainLayout = () => {
  ...
  const showClientSidebar = ["/dashboard","/deposit","/withdraw","/transaction", "/referral", "/package","/myinvestment","/depositSummary","/depositCheckout","/withdrawCheckout","/withdrawSummary"].includes(location.pathname);

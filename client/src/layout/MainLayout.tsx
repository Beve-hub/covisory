...
const MainLayout = () => {
  ...
  const showClientSidebar = ["/dashboard","/deposit","/withdraw","/transaction", "/referral", "/package","/myinvestment","/depositSummary","/depositCheckout","/withdrawCheckout","/withdrawSummary","/settings","/userClient","/usersDetails","/adminTran","/adminWallet","/adminDash","/convert"].includes(location.pathname);
